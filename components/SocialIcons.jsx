  ...
  return (
    <div className={`flex flex-wrap gap-4 ${className}`}>
      ...
      {maybeWrap(
        ...
        <a href="https://linkedin.com/in/ricardozea" target="_blank" rel="noopener noreferrer" title="LinkedIn - Opens a new tab" className="reveal reveal-line" data-reveal-delay="0.1">
      ...
      {maybeWrap(
        ...
        <a href="https://dribbble.com/ricardozea" target="_blank" rel="noopener noreferrer" title="Dribbble - Opens a new tab" className="reveal reveal-line" data-reveal-delay="0.2">
      ...
      {maybeWrap(
        ...
        <a href="https://codementor.io/@ricardozea" target="_blank" rel="noopener noreferrer" title="Codementor - Opens a new tab" className="reveal reveal-line" data-reveal-delay="0.3">
      ...
      {maybeWrap(
        'X - Opens a new tab',
        <a href="https://twitter.com/ricardozea" target="_blank" rel="noopener noreferrer" title="X - Opens a new tab" className="reveal reveal-line" data-reveal-delay="0.6">
