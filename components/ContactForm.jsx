    ...
    <div className="contact-form-wrapper">
      {formStatus.isSubmitted ? (
        <div className="success-message text-center p-6">
          ...
          <h3 className="text-xl font-bold mb-2 text-persistent-light">Message Sent!</h3>
          <p className="text-persistent-light">{formStatus.message}</p>
          <button
            onClick={() => setFormStatus({ ...formStatus, isSubmitted: false })}
            className="mt-4 cta-button button-secondary"
          >
        ...
        <form onSubmit={handleSubmit} className="contact-form flex flex-col gap-6">
          ...
          <div className="form-group">
            <small className="block text-right p-2">All fields are required.</small>
